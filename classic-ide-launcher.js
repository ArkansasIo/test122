...
/**
 * Labyrinth of the Dragon - Classic IDE Editor Launcher
 * Standalone executable for classic tabs layout (http://localhost:5000/classic)
 */

const os = require('os');

const APP_NAME = 'Labyrinth of the Dragon - Classic IDE';
const PORT = 5000;
...
process.env.IDE_LAYOUT = 'classic';

...
export class AbilityManager {
  private abilities: Map<number, Ability> = new Map();
   ...
   * Get ability by ID
   */
  public getAbility(abilityId: number): Ability | null {
 ...
 */
export function loadDefaultAbilities(manager: AbilityManager): void {
  // Fire abilities
